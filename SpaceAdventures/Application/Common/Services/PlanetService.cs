...
namespace SpaceAdventures.Application.Common.Services
{
    public class PlanetService : IPlanetService
    {
        ...
        public async Task<PlanetDto> GetPlanetById(int planetId, CancellationToken cancellation = default)
        {
            ...
            if (planet == null)
            {
                throw new NotFoundException("planet", planetId);
            }
        ...
        public async Task<PlanetDto> UpdatePlanet(int planetId, PlanetInput planetInput, CancellationToken cancellation = default)
        {
            var planet = await _context.Planets.FindAsync(planetId);
